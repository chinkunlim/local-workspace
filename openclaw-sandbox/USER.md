...
5. **Sandbox isolation.** The openclaw-sandbox must remain fully self-contained. No cross-boundary references.
...
- Any file deletion
- Any move or rename of files outside the `openclaw-sandbox/` directory
