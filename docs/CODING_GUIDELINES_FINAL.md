...
```
1. Read docs/CODING_GUIDELINES_FINAL.md  (this file — mandatory)
2. Read memory/CLAUDE.md                 (project collaboration rules)
...
- Extraction skills (`audio-transcriber`, `doc-parser`) must NOT perform summarisation — delegate to `note_generator`.
...
### 5.3 Anti-Hallucination Requirements (audio-transcriber)
...
```bash
OPENCLAW_LOG_JSON=1 python3 skills/audio-transcriber/scripts/run_all.py
```
...
Examples:
  feat(audio-transcriber): add multi-clip majority-vote language detection
...
|---|---|---|---|
| **Global** | `docs/` | Monorepo | `USER_MANUAL.md`, `CODING_GUIDELINES_FINAL.md`, `STRUCTURE.md`, `INDEX.md` |
| **Global AI** | `memory/` | AI Agents | `ARCHITECTURE.md`, `DECISIONS.md`, `HANDOFF.md`, `CLAUDE.md`, `TASKS.md` |
| **Skill** | `open-claw-sandbox/skills/<skill>/docs/` | Skill owner | `ARCHITECTURE.md`, `CLAUDE.md`, `DECISIONS.md` |
