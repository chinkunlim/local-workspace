...
This workspace follows the security rules in `open-claw-workspace/docs/CODING_GUIDELINES_FINAL.md §7`:
...
- All pipeline outputs stay within `open-claw-workspace/data/`
