...
Replaces:
    audio_transcriber/scripts/utils/diff_tool.py
    audio_transcriber/scripts/utils/audit_tool.py
    ...
    def diff_files(
        ...
        Args:
            ...
            strip_log_marker: If provided, everything from this string onward
                              ...
                              for audio_transcriber audit-log footers).
        """
        r = DiffResult(
            file_a=path_a,
            file_b=path_b,
...
# ──────────────────────────────────────────────────────────────────────────────
#  AuditEngine  (generalised from audio_transcriber audit_tool)
# ──────────────────────────────────────────────────────────────────────────────
