...
class Phase0aDiagnostic(PipelineBase):
    ...
    Inherits PipelineBase with skill_name='doc_parser' (V2.2 keyword arg pattern).
    """
    ...
    def __init__(self) -> None:
        ...
        if self.min_text_chars is None:
            raise RuntimeError(
                "doc_parser config missing pdf_processing.diagnostic.min_text_chars_first_page"
            )
