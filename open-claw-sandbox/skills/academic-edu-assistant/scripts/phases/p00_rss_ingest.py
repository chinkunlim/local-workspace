"""
skills/academic-edu-assistant/scripts/phases/p00_rss_ingest.py  (P2-2)
=====================================================================
Proactive RSS/Atom feed ingestion for the academic-edu-assistant skill.
...
doc-parser automatically.

Config (academic-edu-assistant/config/config.yaml):
    rss:
      feeds:
        - name: "cs.AI"
