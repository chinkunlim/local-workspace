...
symmetrical with QueueManager in doc-parser.
...
- StateManager now explicitly declares skill_name="audio-transcriber"
...
class VoiceMemoOrchestrator(PipelineBase):
    ...
    Symmetrical to doc-parser's QueueManager.
    """
    ...
    def startup_check(self) -> bool:
        ...
        Validates:
        1. Input .m4a files exist in data/audio-transcriber/input/
        ...
        try:
            ...
            if not api_url:
                raise RuntimeError("audio-transcriber runtime.ollama.api_url is missing")
    ...
    def run(self, args) -> None:
        """Execute the full audio-transcriber pipeline based on parsed CLI args.
