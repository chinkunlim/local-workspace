"""
skills/knowledge-compiler/scripts/phases/p02_extract_graph.py  (P3-2)
======================================================================
...
class Phase2ExtractGraph(PipelineBase):
    ...
    def __init__(self):
        ...
        self.graph = get_graph_store(self.workspace_root, skill_name="knowledge-compiler")
        ...
        try:
            ...
            EventBus.publish(
                DomainEvent(
                    ...
                    source_skill="knowledge-compiler",
