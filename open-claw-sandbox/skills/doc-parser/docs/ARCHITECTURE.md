...
01_Inbox/<subject>/<pdf_name>.pdf
          ...
          │
          ▼ P3: 知識濃縮合成 (Delegates to note-generator) → content.md
          │
          ▼
...
- `core.StateManager(skill_name="doc-parser")` 管理六個 Phase 的進度
...
| `StateManager(skill_name="doc-parser")` | P0a-P3 進度追蹤 |
...
| `SmartHighlighter` | P2 核心標記引擎 (standalone skill) |
| `NoteGenerator` | P3 核心合成引擎 (standalone skill) |
