...
> AI agent collaboration context for the `inbox-manager` skill.
> Read this file before making any changes to this skill or `core/config/inbox_config.json`.

## Skill Summary

`inbox-manager` is a **pure CLI configuration management utility**. It provides a safe interface
...
| CLI entry point | `skills/inbox-manager/scripts/query.py` |
...
# Remove pattern
python3 skills/inbox-manager/scripts/query.py --remove "_exam"
```
