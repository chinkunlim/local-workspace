...
`open-claw-workspace` is a production-grade local AI automation sandbox running on macOS with 16 GB RAM.
...
7. **Sandbox Boundary.** Skill code must never reference paths outside `open-claw-workspace/`.
