...
This agent operates exclusively within `open-claw-workspace/`. Actions taken outside this directory require explicit operator approval.
...
See `docs/CODING_GUIDELINES.md` Section 7.3 for the AI professional output standard.
