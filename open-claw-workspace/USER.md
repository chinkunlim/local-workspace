...
5. **Sandbox isolation.** The open-claw-workspace must remain fully self-contained. No cross-boundary references.
...
- Any file deletion
- Any move or rename of files outside the `open-claw-workspace/` directory
