...
class Phase1aDiagnostic(PipelineBase):
    ...
    def run_diagnostics(self, pdf_path: str, pdf_id: str) -> DiagnosticReport:
        """
        ...
        """
        report = DiagnosticReport(pdf_path=pdf_path, pdf_id=pdf_id)
        ...
        self.info(f"📋 [Diagnose] 開始診斷: {os.path.basename(pdf_path)}")
    ...
    def _write_scan_report(self, report: DiagnosticReport):
        ...
        output_dir = os.path.join(self.dirs["processed"], report.pdf_id)
