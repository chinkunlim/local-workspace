...
- open-claw-workspace: Skill framework and domain pipelines (voice-memo, pdf-knowledge)
...
Skill-level logs are under data/<skill>/logs in open-claw-workspace.

## 4. OpenClaw Structure
See open-claw-workspace/AGENTS.md and open-claw-workspace/docs/CODING_GUIDELINES.md for contributor and agent contracts.
...
## 6. Change Discipline
When code changes are made in open-claw-workspace, update:
- related skill docs in skills/<skill>/docs/*.md
- open-claw-workspace/docs/CODING_GUIDELINES.md when standards change
